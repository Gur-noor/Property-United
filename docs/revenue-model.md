...
Charged on each whitelisted secondary transfer of property tokens between investors. This fee is earned every time an existing token holder transfers their position to another verified investor through the platform's peer-to-peer transfer mechanism. Rate: **0.25–1% per whitelisted trade**.

---

## Illustrative Revenue Scaling

The table below illustrates how platform revenue scales with AUM, based on the fee structure above:

| Portfolio | AUM | Illustrative Annual Revenue |
|---|---|---|
| 10 properties @ $300k avg | $3M | ~$80,000/yr |
| ~100 properties @ $300k avg | $30M | ~$800,000/yr |
