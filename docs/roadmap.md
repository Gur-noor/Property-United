...
```mermaid
flowchart LR
    P0["<b>Phase 0</b><br/>Foundation<br/><i>Off-chain</i>"] --> P1["<b>Phase 1</b><br/>Onboarding<br/><i>Off-chain</i>"]
    P1 --> P2["<b>Phase 2</b><br/>First Property<br/><i>On-chain</i>"]
    P2 --> P3["<b>Phase 3</b><br/>Multi-Property<br/><i>On-chain</i>"]
